...
interface UpdatePackageContentInfoProps {
  id: number;
  formik: FormikProps<TourUpdateType>;
}
const UpdatePackageContentInfo: React.FC<UpdatePackageContentInfoProps> = ({
  id,
  formik,
}) => {
  ...
  const initialValues: NavigationsListType = {
    navigations: formik.values.navigate,
  };
...
export default UpdatePackageContentInfo;
